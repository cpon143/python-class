...
regEnel = Entry(root, textvariable= regNo, font = entryfont).place(x=280, y=100,width=200,height=25)
...
def recapp():
    ...
    result_str = ''.join(randon.choice(letters) for i in range(9))
